...
void FinishPage_Init()
{
    ...
    restartButton = new Button(fontPath, { -300.0f, -320.0f }, { 300.0f, 75.0f },
        []() { ShowConfirm([]() { OnFinishRestartClicked(); }); },
        { 0.0f, 1.0f, 0.0f, 1.0f }, "Restart");

    menuButton = new Button(fontPath, { 300.0f, -320.0f }, { 300.0f, 75.0f },
        []() { ShowConfirm([]() { OnFinishMenuClicked(); }); },
