...
void GameConfig::Unload()
{
    // Clear Player strings
    s_Player.texture.clear();
    s_Player.texture.shrink_to_fit();

    // Clear all NPC strings
    s_Npc.walk.texture.clear();
    s_Npc.walk.texture.shrink_to_fit();

    s_Npc.melee.texture.clear();
    s_Npc.melee.texture.shrink_to_fit();

    s_Npc.ranger.texture.clear();
    s_Npc.ranger.texture.shrink_to_fit();

    s_Npc.boss.texture.clear();
    s_Npc.boss.texture.shrink_to_fit();
