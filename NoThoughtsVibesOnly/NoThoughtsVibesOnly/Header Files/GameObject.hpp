...
//class GameObject {
//    public:
//    GameObject(AEVec2 pos = { 0.0f, 0.0f }, AEVec2 scale = { 50.0f, 50.0f }, f32 rot = 0.0f, AEGfxTexture* texture = nullptr, f32 width = 100.0f, f32 height = 100.0f, GameState state = static_cast<GameState>(current)); // Default Constructor
